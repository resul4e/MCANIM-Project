...
// GLEW/GLFW
#include <glad/glad.h>    // This example is using glew to access OpenGL functions (because it is small). You may use glew/glad/glLoadGen/etc. whatever already works for you.
